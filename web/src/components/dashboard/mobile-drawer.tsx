...
import { X, LogOut, LayoutDashboard, KeyRound, Settings, BookOpen } from 'lucide-react';
      ...
      {open && (
        ...
        >
          ...
          <motion.aside
            ...
            className="relative flex h-full w-64 flex-col border-r border-border bg-neutral-900"
          >
            <button
              onClick={onClose}
